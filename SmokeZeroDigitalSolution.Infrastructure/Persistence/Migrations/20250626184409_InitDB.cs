        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThresholdType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SubscriptionPlans_CurrentSubscriptionPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CigarettesSmokedToday = table.Column<int>(type: "integer", nullable: false),
                    MoneySavedToday = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    HealthStatusNotes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CravingLevel = table.Column<int>(type: "integer", nullable: false),
                    Challenges = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Successes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReasonToQuit = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    InitialCigarettesPerDay = table.Column<int>(type: "integer", nullable: false),
                    InitialCostPerCigarette = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuittingPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuittingPlans_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostIncurred = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SmokingRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CurrentSubscriptionPlanId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuittingPlans_UserId",
                table: "QuittingPlans",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SmokingRecords_UserId",
